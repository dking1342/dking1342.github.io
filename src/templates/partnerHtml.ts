export const partnerHtmlTemplate = (data: any) => {
  return `
  <html>
    <head>
      <style>
    ...
    <body>
      <header>
        ...
        <p>You have received a message from the partner contact form. Please see below for the details</p>      
      </header>
      <section>
        <div>
        ...
        <div>
          <span>Reason:</span> <span>${data.partnerReason}</span>
        </div>
      </section>
