export const volunteerHtmlTemplate = (data: any) => {
  return `
  <html>
    <head>
      <style>
    ...
    <body>
      <header>
        ...
        <p>You have received a message from the volunteer contact form. Please see below for the details</p>      
      </header>
      <section>
        <div>
        ...
        <div>
          <span>Reason:</span> <span>${data.volunteerReason}</span>
        </div>
      </section>
