...
const animals = ({ data, loading, error }: Props) => {
  if (loading) {
    return <Loading />;
    ...
    return (
      <section>
        <Head>
          <title>Impact: Animals</title>
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <meta
            name="description"
            content="mission compassion impact page for animals"
          />
        </Head>
        <main
        ...
        >
          {/* hero section */}
          <HeroImpact page="impact" subtitle="animal" />
          {/* customer impacts */}
